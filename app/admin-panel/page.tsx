...
const ImageEditor: React.FC = () => {
  ...
  const serializeCanvasState = () => {
    ...
    return {
      ...
      backgroundType,
      backgroundColor,
      gradientConfig: backgroundType === "gradient" ? gradientBackground : null,
      patternId: selectedPattern?.id || null,
      presetKey: currentPreset,
      textElements: texts.map((t) => ({
        content: t.content,
        x: t.x,
        y: t.y,
        fontSize: t.fontSize,
    ...
    try {
      ...
      const response = await fetch("/api/sample", {
        ...
        body: JSON.stringify({
          ...
          category: currentPreset
            ? presetSizes[currentPreset].category
            : "Custom",
          ...canvasState,
        }),
      });
            ...
            <div className="space-y-6">
              ...
              <div className="border-t pt-6">
                ...
                <button
                  ...
                  className="w-full bg-purple-500 hover:bg-purple-600 text-white px-4 py-3 rounded-lg flex items-center justify-center gap-2 transition-colors font-semibold mb-3"
                >
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-md mx-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Modern YouTube Thumbnail"
              ...
              <div className="bg-gray-50 rounded-lg p-3 text-sm">
                ...
                <ul className="space-y-1 text-gray-600">
                  <li>• {texts.length} text element(s)</li>
                  <li>• {images.length} image(s)</li>
                  <li>
                    • Canvas: {currentCanvasSize.width}×
                    {currentCanvasSize.height}px
                  </li>
                  <li>• Background: {backgroundType}</li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
              >
