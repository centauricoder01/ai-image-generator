...
const renderContent = () => {
  ...
  if (data.contentType === 'text' && data.textEntries && data.textEntries.length > 0) {
    return (
                ...
                <div className="rounded overflow-hidden border border-gray-200">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      errorDiv.className = 'p-2 bg-red-50 text-red-600 text-xs text-center';
          ...
          <div className="w-full h-20 flex items-center justify-center bg-black rounded overflow-hidden">
            <video 
              ...
              onError={(e) => {
                ...
                e.currentTarget.style.display = 'none';
                const sibling = e.currentTarget.parentElement?.nextElementSibling as HTMLElement | null;
                if (sibling) {
